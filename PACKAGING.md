...
| Gentoo GURU | Pending push | `gui-apps/hyprmoncfg` is in [Gentoo GURU](https://github.com/gentoo/guru/tree/master/gui-apps/hyprmoncfg); the 1.9.1 update is prepared for publication. |
