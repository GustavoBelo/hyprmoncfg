...
| Gentoo GURU | Staged | [`gui-apps/hyprmoncfg` 1.17.0](https://github.com/gentoo/guru/tree/dev/gui-apps/hyprmoncfg) remains published. The 1.17.1 ebuild and Manifest are staged, but the required hardware-OpenPGP PIN approval is still needed to sign the GURU commit. |
